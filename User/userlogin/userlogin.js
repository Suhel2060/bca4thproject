window.addEventListener("load", () => {
  ...
  if (status == "user") {
    ...
    document.querySelector(".login-user").style.display = "flex";
    document.querySelector("#user-name").innerHTML = username;
    document.querySelector(".login-user img").src = '../../admin/addstudents/studentimg/'+image;
...
function userlogin(user_name,image) {
