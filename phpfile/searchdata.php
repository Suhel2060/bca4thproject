...
$searchstring6="%".$search."%";
// $searchstring3="%".$search."%";
$query="select * from bookdetails where tag like '$searchstring1' or tag like '$searchstring5' or tag like '$searchstring2' or bookname like '$searchstring3' or authorname like '$searchstring6'";
